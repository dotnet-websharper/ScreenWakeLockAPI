...
(function(Global)
{
 ...
 WebSharper$ScreenWakeLock$Sample_Templates=Global.WebSharper$ScreenWakeLock$Sample_Templates=Global.WebSharper$ScreenWakeLock$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_ScreenWakeLock_Sample$Client=Global.StartupCode$WebSharper_ScreenWakeLock_Sample$Client||{};
 ...
 {
  var _,b,t,_this,p,i;
  _=(b=(t=(_this=new ProviderBuilder.New$1(),(_this.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this)),(t.h.push(Handler.EventQ2(t.k,"wakebutton",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.requestWakeLock()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$ScreenWakeLock$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.requestWakeLock=function()
 {
  var _;
  function f()
  {
   function f$1()
   {
    return self.navigator.wakeLock.request("screen").then(function(a)
    {
     Client.statusMessage().Set("Screen Wake Lock is active!");
     a.addEventListener("release",function()
     {
      return Client.statusMessage().Set("Wake Lock released!");
     });
   ...
   function f$2(a)
   {
    Client.statusMessage().Set("Wake Lock Error: "+Global.String(a.message));
    return Promise$1.resolve(null);
   }
 ...
 WebSharper$ScreenWakeLock$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.statusMessage=Var$1.Create$1("Click the button to keep the screen awake.");
 };
