...
function Main(){
  ...
  const b=(t.h.push(EventQ2(t.k, "wakebutton", () => t.i, () => {
    const _3=null;
    Start(Delay(() => Bind(AsAsync(requestWakeLock()), () => Return(null))), null);
  })),t);
...
function requestWakeLock(){
  ...
  return new Promise((_2) => {
    _2(new Promise((_3) => {
      _3(globalThis.navigator.wakeLock.request("screen").then((d) => {
        statusMessage().Set("Screen Wake Lock is active!");
        d.addEventListener("release", () => statusMessage().Set("Wake Lock released!"));
        return Promise.resolve(null);
      }));
    })["catch"]((d) => {
      const a=unwrapExn(d);
      statusMessage().Set("Wake Lock Error: "+String(a.message));
      return Promise.resolve(null);
    }));
  });
}
...
let _c_7=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.statusMessage=_c_12.Create_1("Click the button to keep the screen awake.");
  }
});
function NewGuid(){
